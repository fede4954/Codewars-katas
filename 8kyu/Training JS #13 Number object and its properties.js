...
const whatNumberIsIt = (n) => {
    ...
    if (Number.POSITIVE_INFINITY === n) return 'Input number is Number.POSITIVE_INFINITY'
    if (Number.NEGATIVE_INFINITY === n) return 'Input number is Number.NEGATIVE_INFINITY'
}