...
const topSecret = (str) => {
    ...
    for (let i = 0; i < str.length; i++) {
        ...
        if (charCode >= 65 && charCode <= 67 || charCode >= 97 && charCode <= 99) decryption.push(String.fromCharCode(charCode + 23))
        else if (charCode < 65 || charCode > 122 || (charCode >= 91 && charCode <= 96)) decryption.push(str[i])
        else decryption.push(String.fromCharCode(charCode - 3))
    }
